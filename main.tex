...
\label{sec:intro}
    ...
    \begin{itemize}
        ...
        \item Payment for~a~single subtask may be as low as \$0.01 or even \$0.001 for~some types of~tasks.
          \marginpar{Typowa wielkość subtasku w godzinach CPU?}
    \end{itemize}
...
\newcommand{\total}[2]{\widehat{#1}_{#2}}
    ...
    $p\cdot n = 10$. The user will get at least 80\% of the expected income if she wins in at least $80\cdot p\cdot n = 8$ lotteries, 
